...
echo "<h1>Servidor HTTPS ${SERVER_CN} UP  </h1>" > /var/www/${SERVER_CN}/index.html
...
echo "FORA DO DOCKER: sudo nano /etc/hosts -> FORA DO DOCKER
adicionar uma linha 10.9.0.80 www.antixerox2025"
